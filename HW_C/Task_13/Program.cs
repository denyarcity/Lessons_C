...
Console.Write("Укажите из какого диапазона случайных чисел от А до N будут генерироваться числа? Введите число А: ");
int a = Convert.ToInt32(Console.ReadLine());
Console.Write("Укажите из какого диапазона случайных чисел от А до N будут генерироваться числа? Введите число N: ");
...
void FillArray (int[] collection)//метод который присваивает к каждому индексу в массиве случайное число.
{
    ...
    {
        collection[index] = new Random() .Next(a,n);//collection[index] - обращаемся к индексу в аргументе и присваиваем ему новое случайное число в промежутке от 1 до "n" 
        index++;// index = index + 1
    }
}
