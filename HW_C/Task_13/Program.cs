...
int[] array = new int[i]; //просим программу создать массив из 8 элементов
...
void FillArray (int[] collection)//метод который присваивает к каждому индексу в массиве случайное число.
{
    ...
    {
        collection[index] = new Random() .Next(0,n);//collection[index] - обращаемся к индексу в аргументе и присваиваем ему новое случайное число в промежутке от 1 до 100 
        index++;// index = index + 1
    }
}
